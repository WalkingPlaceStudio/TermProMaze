...
Launch the Game using ./TermProMaze if it doesnt work you may use Bash TermProMaze
TermProMaze is a simple game Built completely on Bash 
it is Fully open source for modifying 
Feel free to take termpromaze and modify it even make it close source
you must enter the directory to execute it
